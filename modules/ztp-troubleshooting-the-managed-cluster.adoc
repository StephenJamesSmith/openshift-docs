...
. You can find information about why the installation was unsuccessful by describing the
AgentClusterInstall resource and checking the status and event logs:
+
[source,terminal]
----
...
. If possible, fix the errors and do the following:
